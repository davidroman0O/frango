...
// GetScript returns the provided PHP globals script
func (p *DefaultGlobalsProvider) GetScript() string {
	return p.Script
}

// GetPath returns the provided path for the PHP globals script
func (p *DefaultGlobalsProvider) GetPath() string {
	return p.Path
}
