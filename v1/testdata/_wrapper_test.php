...
require_once '/var/folders/h2/lww7d7p5049dx4qzhxgk33640000gn/T/frango-57d3052b/vfs-ed53e08f/_frango_php_globals.php'; // Load globals initialization
...
try {
    include 'test.php'; // Load main script
} catch (Throwable $e) {
